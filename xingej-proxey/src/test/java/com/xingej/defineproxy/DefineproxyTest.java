 ...
 * JDK动态代理测试
 * 
 * @author erjun 2018年1月8日 上午10:23:26
 */
public class DefineproxyTest {
    ...
    //自定义动态代理方式测试
    @Test
    public void testByDefineJDK() throws Throwable {
        System.out.println("===================自定义的动态代理===================");

        Person definePerson = (Person) MyProxy.createProxyInstance(Person.class.getClassLoader(), Person.class,
